...
{
    public partial class pgLoginNovo : System.Web.UI.Page
    {
        ...
        public void LimparFormularioRecuperarSenha()
        {
            txtUsuarioRecuperarSenha.Text = string.Empty;
        }
        ...
        #region Eventos Recuperar Senha

        protected void lkbRecuperarSenha_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                listaUsuario = usuarioBO.BuscarPorNomeExpecifico(txtUsuarioRecuperarSenha.Text);
                gvMostrarSenha.DataSource = listaUsuario;
                gvMostrarSenha.DataBind();

                LimparFormularioRecuperarSenha();

                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "openMostrarSenhaModal();", true);
            }
            catch (Exception ex)
            {
                Mensagem(ex.Message, this);
        ...
        protected void lkbCancelarRecuperarSenha_Click(object sender, EventArgs e)
        {
            LimparFormularioRecuperarSenha();
        }

        protected void lbCancelarMostrarSenha_Click(object sender, EventArgs e)
        {
            gvMostrarSenha.DataSource = null;
            gvMostrarSenha.DataBind();
        }
